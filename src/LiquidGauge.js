...
export default class LiquidGauge extends Component {
  ...
  renderLiquidGauge(elementId, value) {
    ...
    var gaugeCircleX = d3.scale.linear().range([0, 2 * Math.PI])
      .domain([0, 1]);
    var gaugeCircleY = d3.scale.linear().range([0, radius])
      .domain([0, radius]);
    ...
    var clipArea = d3.svg.area()
      ...
      .y0(function(d) {
        return (
          waveScaleY(Math.sin(Math.PI * 2 * config.waveOffset * -1 +
